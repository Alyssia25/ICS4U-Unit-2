...
class Snowfox extends to Animalclass {
   /**
       * @param name
       * @param colour
       * @param maxSpeed
*/
   ...
   public void accelerate(double acceleratePower,
       ...
       += (acceleratePower * accelerateTime * 6);
       setSpeed(newSpeed);
   }

   // public method to break
   public void brakeSnowfox(double brakePower,
       double brakeTime) {
       int newSpeed = getCurrentSpeed()
       -= (brakePower * brakeTime * 8);
       setSpeed(newSpeed);
   }

   public String provideAbility {
       return SpecialAbility; + "-> Ice attack! gray-wolf freeze for 25 seconds!";
   }
